...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        try {
            ...
            if (apiKey) {
                console.log('[Prophecy Generate] Calling OpenAI for blended prophecy...');
...
- Use 2-3 relevant emojis (🌱, 💀, 💰, 🔮, ⚡).`;
                ...
                if (completion.ok) {
                    ...
                    console.error('[Prophecy Generate] AI Call failed:', completion.status);
            ...
            console.warn('[Prophecy Generate] AI failed, falling back to templates:', aiError.message);
